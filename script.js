...
function renderNavbar(){const n=document.querySelector(".navbar");if(!n)return;const page=location.pathname.split("/").pop()||"index.html";const user=localStorage.getItem("username")||"Admin";n.innerHTML=`<a href="index.html" class="navbar-brand">Absenku</a><ul class="navbar-menu"><li><a href="index.html" class="${page==="index.html"?"active":""}">Dashboard</a></li><li><a href="input_absensi.html" class="${page==="input_absensi.html"?"active":""}">Input Absensi</a></li><li><a href="tampil_siswa.html" class="${["tampil_siswa.html","tambah_siswa.html","edit_siswa.html"].includes(page)?"active":""}">Data Siswa</a></li></ul><div class="navbar-user"><span>Halo, <strong>${escapeHtml(user)}</strong></span><a href="logout.html" class="btn-logout" onclick="return confirm('Apakah Anda yakin ingin keluar?')">Logout</a></div>`}
